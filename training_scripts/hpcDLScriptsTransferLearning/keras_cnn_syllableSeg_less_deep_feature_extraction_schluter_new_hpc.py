...
if __name__ == '__main__':
    ...
    for running_time in range(5):
        ...
        file_path_model = '/homedtic/rgong/cnnSyllableSeg/out/keras.cnn_syllableSeg_jan_artist_filter_less_deep_feature_extraction_schluter'+str(running_time)+'.h5'
        file_path_log = '/homedtic/rgong/cnnSyllableSeg/out/log/keras.cnn_syllableSeg_jan_artist_filter_less_deep_feature_extraction_schluter'+str(running_time)+'.csv'
