...
# ----------------------------------
start=`date +%s`
cp -rp /homedtic/rgong/cnnSyllableSeg/syllableSeg/feature_all_artist_filter_madmom_positiveThree.h5 /scratch/rgongcnnSyllableSeg_jan_madmom_original/syllableSeg/
end=`date +%s`
...
# Output/Error Text
# ----------------
#$ -o /homedtic/rgong/cnnSyllableSeg/out/cnn_jan_madmom.$JOB_ID.out
#$ -e /homedtic/rgong/cnnSyllableSeg/error/cnn_jan_madmom.$JOB_ID.err

python /homedtic/rgong/cnnSyllableSeg/jingjuSyllabicSegmentation/training_scripts/hpcDLScriptsPositiveThreeSampleWeighting/keras_cnn_syllableSeg_jan_madmom_original.py
