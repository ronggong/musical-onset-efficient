...
python /homedtic/rgong/cnnSyllableSeg/jingjuSyllabicSegmentation/training_scripts/newHpcDLScriptsCRNNOverlap/keras_cnn_syllableSeg_jan_madmom_original_ismir.py 0 5