from syllableSeg_jan_madmom_original_basecode_3channels import syllableSeg_jan_madmom_original_basecode
import sys
...
if __name__ == '__main__':
    ...
    for ii in range(low_cv_bound, high_cv_bound):
        syllableSeg_jan_madmom_original_basecode(part, ii)