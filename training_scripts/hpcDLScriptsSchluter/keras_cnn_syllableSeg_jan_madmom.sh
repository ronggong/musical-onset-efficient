...
# Output/Error Text
# ----------------
#$ -o /homedtic/rgong/cnnSyllableSeg/out/schluter_jan_madmom.$JOB_ID.out
#$ -e /homedtic/rgong/cnnSyllableSeg/error/schluter_jan_madmom.$JOB_ID.err
...
python /homedtic/rgong/cnnSyllableSeg/jingjuSyllabicSegmentation/training_scripts/hpcDLScriptsSchluter/keras_cnn_syllableSeg_jan_madmom.py
